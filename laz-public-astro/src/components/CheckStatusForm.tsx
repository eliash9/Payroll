                ...
                <form onSubmit={handleSubmit(onSubmit)} className="grid sm:grid-cols-3 gap-4">
                    <div className="sm:col-span-1">
                        ...
                        <input
                            ...
                            className="w-full border-slate-300 rounded-lg shadow-sm focus:border-laz-green-500 focus:ring-laz-green-500 uppercase p-2 border"
                        />
                    ...
                    <div className="sm:col-span-1">
                        ...
                        <input
                            ...
                            className="w-full border-slate-300 rounded-lg shadow-sm focus:border-laz-green-500 focus:ring-laz-green-500 p-2 border"
                        />
                    ...
                    <div className="sm:col-span-1 flex items-end">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-laz-green-500 hover:bg-laz-green-600 text-white font-medium py-2.5 rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-70 cursor-pointer"
                        >
