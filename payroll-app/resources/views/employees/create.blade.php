            ...
            <form method="post" action="{{ route('employees.store') }}" class="space-y-4">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input name="basic_salary" type="number" step="0.01" class="w-full border rounded px-3 py-2">
                    </div>
                    <div>
                        <label class="text-sm">Hourly Rate</label>
                        <input name="hourly_rate" type="number" step="0.01" class="w-full border rounded px-3 py-2">
                    </div>
                    <div>
