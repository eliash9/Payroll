            ...
            <form method="post" action="{{ route('employees.store') }}" class="space-y-4">
                ...
                <div class="grid md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input name="basic_salary" type="number" step="0.01" class="w-full border rounded px-3 py-2 text-right" value="{{ old('basic_salary') }}">
                    </div>
                    <div>
                        <label class="text-sm">Hourly Rate</label>
                        <input name="hourly_rate" type="number" step="0.01" class="w-full border rounded px-3 py-2 text-right" value="{{ old('hourly_rate') }}">
                    </div>
                    <div>
                        <label class="text-sm">Commission %</label>
                        <input name="commission_rate" type="number" step="0.01" class="w-full border rounded px-3 py-2">
                    </div>
                </div>
                <div class="grid md:grid-cols-3 gap-4">
                    <div>
                    ...
                    <div class="flex items-center gap-2 pt-6">
                        <input type="checkbox" name="is_volunteer" value="1" id="is_volunteer" @checked(old('is_volunteer'))>
