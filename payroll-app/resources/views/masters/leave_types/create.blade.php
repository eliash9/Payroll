<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Jenis Cuti/Izin</h2>
    </x-slot>
            ...
            <form method="post" action="{{ route('leave-types.store') }}" class="space-y-4">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input name="default_quota_days" class="w-full border rounded px-3 py-2" type="number" step="0.01" min="0" value="{{ old('default_quota_days') }}">
                    </div>
                </div>
                <div class="flex items-center gap-4">
                    ...
                    <label class="flex items-center gap-2 text-sm">
                        <input type="checkbox" name="is_annual_quota" value="1" @checked(old('is_annual_quota'))>
                        Potong Cuti Tahunan
                    </label>
                </div>
