<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Cabang</h2>
    </x-slot>
    ...
    <div class="py-8 max-w-4xl mx-auto">
        <div class="bg-white shadow-sm rounded p-4">
            <form method="post" action="{{ route('branches.store') }}" class="space-y-4">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="flex items-center space-x-2 mt-6">
                            <input type="checkbox" name="is_headquarters" value="1" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" @checked(old('is_headquarters'))>
                ...
                <div class="mt-4">
                    <label class="text-sm font-semibold mb-2 block">Lokasi Cabang (Geser marker untuk set lokasi)</label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Check if inputs already have value (e.g. valid failure return)
            if (latInput.value && lngInput.value) {
                ...
                zoom = 15;
                 ...
                 navigator.geolocation.getCurrentPosition((position) => {
                     ...
                     if (!latInput.value) { // Only update if still empty
