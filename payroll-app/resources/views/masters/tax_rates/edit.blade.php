            ...
            <form method="post" action="{{ route('tax-rates.update', $taxRate->id) }}" class="space-y-4">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input name="range_min" type="number" min="0" class="w-full border rounded px-3 py-2 text-right" required value="{{ old('range_min', $taxRate->range_min) }}">
                    </div>
                    <div>
                        <label class="text-sm">Range Max</label>
                        <input name="range_max" type="number" min="0" class="w-full border rounded px-3 py-2 text-right" value="{{ old('range_max', $taxRate->range_max) }}">
                    </div>
                    <div>
