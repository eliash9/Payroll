<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Tarif Pajak</h2>
    </x-slot>

    <div class="py-8 max-w-4xl mx-auto">
        <div class="bg-white shadow-sm rounded p-4">
            <form method="post" action="{{ route('tax-rates.store') }}" class="space-y-4">
                @csrf
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input name="year" type="number" min="2000" class="w-full border rounded px-3 py-2" required value="{{ old('year') }}">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input name="rate_percent" type="number" step="0.01" min="0" class="w-full border rounded px-3 py-2" required value="{{ old('rate_percent') }}">
                    </div>
                </div>
