            ...
            <form method="post" action="{{ route('departments.update', $department->id) }}" class="space-y-4">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input name="name" class="w-full border rounded px-3 py-2" required value="{{ old('name', $department->name) }}">
                    </div>
                    <div>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('departments.index') }}" class="text-slate-600 px-4 py-2">Batal</a>
                </div>
            </form>
        </div>
    </div>
