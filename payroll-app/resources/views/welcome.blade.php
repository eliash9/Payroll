...
<img src="{{ asset('images/logo.png') }}" class="w-12 h-6 object-contain" alt="Logo">
                    ...
                    <div class="space-x-4">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-indigo-600 transition duration-300">Log in</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="ml-4 font-semibold text-white bg-indigo-600 px-5 py-2.5 rounded-lg hover:bg-indigo-700 transition duration-300 shadow-lg shadow-indigo-500/30">Register</a>
                            @endif
                        @endauth
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8 w-full pt-24 sm:pt-32">
                <div class="flex flex-col items-center justify-center text-center">
                    ...
                    <div class="mb-8 relative group inline-block">
                        ...
                        <div class="relative px-6 py-2 bg-white ring-1 ring-gray-900/5 rounded-full leading-none flex items-center space-x-2">
                            <span class="text-indigo-600 font-bold text-xs uppercase tracking-wider">New</span>
                            <span class="text-slate-600 text-sm">Seamless Payroll Management v2.0</span>
                        </div>
                    </div>

                    <h1 class="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900 mb-6 leading-tight">
                        Payroll Management <br class="hidden sm:block">
                    ...
                    <p class="mt-4 text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
                        Simplify your HR operations with our comprehensive payroll solution. Automated calculations, secure data management, and insightful reporting all in one place.
                    </p>
                ...
                <div id="features" class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-24 px-4">
                    ...
                    <div class="bg-white/60 backdrop-blur-sm p-8 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 border border-white/20 hover:border-indigo-100 group">
                        ...
                        <p class="text-gray-600 leading-relaxed">Automated tax, BPJS, and overtime calculations. Minimize errors and save valuable time every month.</p>
                    </div>
                    ...
                    <div class="bg-white/60 backdrop-blur-sm p-8 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 border border-white/20 hover:border-purple-100 group">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-3">Employee Hub</h3>
                        <p class="text-gray-600 leading-relaxed">Centralized database for all employee information, attendance records, and leave management.</p>
                    </div>
                    ...
                    <div class="bg-white/60 backdrop-blur-sm p-8 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 border border-white/20 hover:border-pink-100 group">
                        ...
                        <p class="text-gray-600 leading-relaxed">Built with security in mind. Ensure your data is safe and your processes comply with local regulations.</p>
                    </div>
                </div>

                <div class="mt-24 pb-10 text-center text-sm text-gray-500 border-t border-gray-200 pt-8">
                    &copy; {{ date('Y') }} {{ config('app.name', 'Payroll App') }}. All rights reserved.
                </div>
            </div>
